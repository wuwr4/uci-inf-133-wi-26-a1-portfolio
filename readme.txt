--Readme document for *WANRONG WU*, *wuwr@uci.edu*--
...
(a) Basic features
- Images with completed alt attributes 
    - Alt attributes are vague because I used placeholder images
- Headings and paragraph text
- Link to external page (github.com)
- Multiple pages, accessible via navbar
- A footer at the bottom of each page

(b) CSS features
- Padding and margins on most elements
- Bootstrap components (accordions, navbar, cards, buttons, pill badges)
    - Component layout adapts to different screen sizes

(c) Advanced features
- A sticky navbar that's always visible on screen regardless of scrolling
- A contact form with a name, email, and message field
...
- I worked on this assignment for 5 days with an average of 3 hours each day, so ~15 hours.


5. What online resources did you consult when completing this assignment? (list specific URLs, describe queries to Generative AI, or use of AI-based code completion)
- https://getbootstrap.com/docs/5.3/components
- https://www.w3schools.com/bootstrap/bootstrap_navbar.asp
- ChatGPT, for help converting Bootstrap utilities to CSS in order to maintain readability
